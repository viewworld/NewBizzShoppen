...
if Object.const_defined?("Ckeditor")
  Ckeditor.setup do |config|
    ...
    # Set to nil or [] (empty array) for all file types
    # Microsoft Office MIME types: http://filext.com/faq/office_mime_types.php
    # Open Document MIME types: http://en.wikipedia.org/wiki/OpenDocument_technical_specification
    config.attachment_file_types = ["doc", "docx", "xls", "xlt", "xlsx", "odt", "ods", "pdf", "rar", "zip", "tar", "swf", "txt"]
    ...
    #
    # # Path for upload files process # is it still used?
    ...
    #
    # # Path for upload images process # is it still used?
