module EmailTemplateHelp
  ...
  HELP = {
      ...
      "survey_newsletter" => {:classes => [], :custom => ["survey_name", "survey_link", "company_name" , "first_name", "last_name"]},
      "survey_campaign" => {:classes => [], :custom => ["survey_name", "survey_link", "company_name" , "first_name", "last_name"]},
