...
SELECT pg_catalog.setval('categories_id_seq', 851, true);
...
SELECT pg_catalog.setval('category_translations_id_seq', 854, true);
...
SELECT pg_catalog.setval('countries_id_seq', 716, true);
...
SELECT pg_catalog.setval('currencies_id_seq', 645, true);
...
SELECT pg_catalog.setval('invoices_id_seq', 39, true);
...
SELECT pg_catalog.setval('lead_purchases_id_seq', 289, true);
...
SELECT pg_catalog.setval('lead_translations_id_seq', 657, true);
...
SELECT pg_catalog.setval('leads_id_seq', 656, true);
...
SELECT pg_catalog.setval('users_id_seq', 1474, true);
