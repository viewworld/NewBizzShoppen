class ChangeDebtorsViewToSubPeriods < ActiveRecord::Migration
  def self.up
    ...
    execute %{
              ...
              WHERE subscriptions.billing_cycle > 0 AND subscription_sub_periods.billing_date IS NOT NULL AND subscription_sub_periods.billing_date <= 'now'::text::date AND subscription_sub_periods.invoice_id IS NULL AND subscriptions.use_paypal IS NOT TRUE;
             }
  end
