class ChangeContactCustomFieldType < ActiveRecord::Migration
  ...
  def self.drop_newsletter_subscribers_view
    execute %{ DROP VIEW newsletter_subscribers; }
  end

  def self.create_newsletter_subscribers_view
    execute %{
