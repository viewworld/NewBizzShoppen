class IncludeIsReportedInViews < ActiveRecord::Migration
  def self.up
    execute %{
            DROP VIEW agent_timesheets_cost;
            DROP VIEW agent_timesheets_payouts;
            DROP VIEW agent_timesheets_results;
    }
            ...
            CREATE OR REPLACE VIEW agent_timesheets_payouts AS
               SELECT
                ...
                CASE
                 ...
                 INNER JOIN campaigns_results ON campaigns_results.campaign_id = contacts.campaign_id AND campaigns_results.result_id = call_results.result_id
