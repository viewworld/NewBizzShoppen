class ChangeNewsletterTagSubscribers2 < ActiveRecord::Migration
  def self.up
    execute %{
      ...
      where taggings.taggable_type<>'TagGroup' and taggings.taggable_type<>'SurveyOption' and newsletter_sources.source_type = 4 and tag_groups.match_all is false
      ...
      left join campaigns on campaigns.id = taggings.taggable_id
      left join leads on leads.id = taggings.taggable_id
      where taggings.taggable_type<>'TagGroup' and taggings.taggable_type<>'SurveyOption' and newsletter_sources.source_type = 4 and tag_groups.match_all is true
