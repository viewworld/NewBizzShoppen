...
Scenario: I can sort by coulmns type, Name, Last Name, email, age, bought, created, volume sold, revenue, payout %
...
Scenario: I can see the name of an account I am browsing the subaccounts