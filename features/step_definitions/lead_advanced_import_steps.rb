Then /^lead advanced import all correct$/ do
  ...
  And %{I press translated "leads_advanced_import.form.view.button"}
  And %{I should see translated "leads_advanced_import.choose.view.title" with options "category:Business"}
  And %{I press translated "leads_advanced_import.choose.view.next_button"}
  And %{I should see translated "leads_advanced_import.preview.view.title" with options "category:Business"}
  And %{I follow translated "leads_advanced_import.preview.view.cancel_button"}
  And %{I should see translated "leads_advanced_import.choose.view.title" with options "category:Business"}
  And %{I press translated "leads_advanced_import.choose.view.next_button"}
  And %{I should see translated "leads_advanced_import.preview.view.title" with options "category:Business"}
  And %{I press translated "leads_advanced_import.preview.view.import_button"}
  And %{I should see "lead_template_values.value can't be blank"}
  And %{I should see "currency can't be blank"}
  And %{I should see translated "advanced_import.create.flash.success" with options "counter:2 / 4"}
end
...
Then /^lead advanced import wrong files, fields and cancel button$/ do
  ...
  And %{I follow translated "leads_advanced_import.choose.view.cancel_button"}
  And %{I should see translated "leads_advanced_import.form.view.title"}
end
