...
Feature: Front page for procurment
  ...
  # @is @_tested @_done @_deprecated2014
  ...
  # #7450
  # @m19 @_requested @_done @_tested @tgn @_deprecated2014
  ...
  # #7630
  # @m19 @_requested @group_deals @_done @_tested @rb @_deprecated2014
  ...
  # #7630
  # @m19 @_requested @group_deals @_tested @_done @tgn @_deprecated2014
  ...
  # deprecated with the new deal layout
  @m22 @_requested @_done @_tested @ao @_deprecated
...
#    Then I should see "FeaturedDescriptionText" within "div.deal_desc"
  ...
  # #8882
  # @m25 @_requested @_done @_tested @_deprecated2014
  ...
  # #9811
  # @m27 @_requested @tgn @_done @_tested @_deprecated2014
  ...
  # #10901
  # @m32 @_requested @_done @_tested @tgn @_deprecated2014
