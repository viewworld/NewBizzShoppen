...
Feature: News presentation for buyer
  ...
  Background:
    Given I am on the supplier home page
...
Scenario: I can see list of news for buyer (to jest scopnięte, czy też zwykli użytkownicy też mogą się tu dostać)
  And I follow translated "supplier_home.show.view.complete_list_link" within "#news"
  Then I should see translated "news.index.view.suppliers_header"
