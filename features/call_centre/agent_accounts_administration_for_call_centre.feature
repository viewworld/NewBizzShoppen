...
Scenario: I can create call centre agent account
  ...
  And I fill in "user_call_centre_agent_address_attributes_street" with "Derhfjf Blv 32/21"
  And I fill in "user_call_centre_agent_address_attributes_city" with "Hamburg"
  And I fill in "user_call_centre_agent_address_attributes_zip_code" with "234213"
  And I fill in "user_call_centre_agent_address_attributes_county" with "Fejdjd"
