...
Scenario: I can sort by coulmns type, Name, Last Name, email, age,
  ...
  Then I should have value "ann.lead_user2@person.com" in the css path "tr:nth-child(2) td:nth-child(6)"
  ...
  Then I should have value "kirk.lead_user4@person.com" in the css path "tr:nth-child(2) td:nth-child(6)"
