# @invoices @$_admin @m4 @noguess @_deprecated2014
...
# @m5 @ao @added @_done @_tested @_requested @_deprecated2014
...
# @m5 @added @tgn @sprint_5_corrections @_tested @_done @_deprecated2014
...
# @m5 @added @tgn @sprint_5_corrections @_tested @_requested @_done @_deprecated2014
...
# @selenium @ao @_done @_deprecated2014
...
# @_done @ao @selenium @_deprecated2014
...
# @ao @_done @_tested @_deprecated2014
...
# @ao @_done @_tested @tc_file_mgmt @_deprecated2014
...
# @_done @ao @_tested @tc_file_mgmt @_deprecated2014
...
# # @tgn @_done @non_testable @_deprecated2014-blank
# # Scenario: I can print out invoice (bypassing PDF)

# @tgn @m6 @added @_tested  @_requested @_done @_deprecated2014
...
# @tgn @added @_tested @selenium @_requested @_done @_deprecated2014
...
# @tgn @added @_tested @_requested @_done @_deprecated2014
...
# @added @m4b @_done @_requested @_deprecated2014
...
# @added @m4b @_done @tc_file_mgmt @_deprecated2014
...
# @added @m4b @selenium @_done @_deprecated2014
...
# @m5 @sellers @ao @_done @_deprecated2014
...
# @m5 @tgn @_tested @_requested @_done @_deprecated2014
...
# @added @m5 @ao @_done @_tested @_deprecated2014
...
# @added @ao @m5 @_done @_tested @_deprecated2014
...
# @ao @_requested @m7 @selenium @_done @_tested @_deprecated2014
...
# @ao @added @_requested @m7 @_done @_tested @_deprecated2014
...
# @m21 @_requested @tgn @_tested @_done @_deprecated2014
...
# @m21 @_requested @tgn @selenium @_done @_tested @_deprecated2014
...
# @m21 @_requested @tgn @selenium @_tested @_done @_deprecated2014
...
# @m21 @_requested @tgn @_done @_tested @selenium @_deprecated2014
...
# # @m22 @_requested @tgn @_done @_non_testable @_deprecated2014-blank
