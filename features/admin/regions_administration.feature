...
Scenario: I can create new region for given country
  ...
  And I fill in "country_name" with "Poland"
  And I fill in "country_locale" with "pl"
  And I fill in "country_detailed_locale" with "pl"
  ...
  And I press translated "administration.countries.new.view.button_create_country"
