...
#  And I uncheck "user_supplier_team_buyers"
...
#  Given I am signed up and confirmed as user with email flag@nbs.com and password secret and role supplier
#  And User flag@nbs.com with role supplier is big buyer
...
#  Then the "user_supplier_team_buyers" checkbox should not be checked
...
#  And User flag@nbs.com with role supplier is big buyer
#  And user "flag@nbs.com" has team buyers enabled
#  And an user with role lead_supplier and email lead_buyer666@person.com exists as subaccount for customer flag@nbs.com
#  And I sign out
#  And I sign in as flag@nbs.com with password secret
#  And I follow translated "layout.my_profile_link"
#  And I uncheck "user_supplier_team_buyers"
