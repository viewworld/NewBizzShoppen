...
Scenario: I create account through signup
  ...
  And I fill in "user_customer_address_attributes_street" with "Street 333"
  And I fill in "user_customer_address_attributes_city" with "London"
  And I fill in "user_customer_address_attributes_zip_code" with "390333"
  And I fill in "user_customer_address_attributes_county" with "Geldow"
