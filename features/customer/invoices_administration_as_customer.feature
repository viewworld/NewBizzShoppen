...
Feature: Invoices administration as customer
  ...
  Background:
    ...
    And invoice line for first invoice exists for user "jon@lajoie.ca" with attributes "netto_price:100,quantity:1,vat_rate:0.23,netto_value:100,brutto_value:123"
