@m15 @cost_calculation @_requested @_tgn
Feature: Cost calculation
  ...
  # @$_administrator @$_call_centre @selenium @_done @_tested @_deprecated2014
  ...
  # @$_administrator @$_call_centre @_done @non_testable @_deprecated2014-blank
  # Scenario: All rates should be stored additionally in Euro for reporting

  # @$_call_centre_agent @_done @non_testable @_deprecated2014-blank
