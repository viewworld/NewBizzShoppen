...
Feature: Sign up feature
  ...
  # 5779
  @m12 @$_guest @_requested @tgn @_done @_tested @selenium @faircalls
  ...
  @m14 @_requested @sign_up @$_customer @tgn @_done @_tested
