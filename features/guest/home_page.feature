...
Feature: Home page
  ...
  # @m8b @_requested @tgn @_tested @_done @faircalls @_deprecated2014
  ...
  # @m8 @_requested @tgn @_tested @_done @_deprecated2014
  ...
  #9269
  # @m26 @_requested @tgn @_done @_tested @_deprecated2014
