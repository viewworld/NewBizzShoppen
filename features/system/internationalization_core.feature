...
Scenario: I can change the language by selecting a flag on the interface
  When locale is set to "en" for translation "supplier_home.show.view.header"
...
Scenario: Default language is displayed if active language translation is not present in the database
  ...
  And I follow translated "locales.dk_locale"
  Then locale is set to "da" for translation "supplier_home.show.view.header"
  And I should see translated "supplier_home.show.view.create_new_supplier_account"