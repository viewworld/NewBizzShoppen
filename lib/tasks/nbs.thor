...
{% endfor %}"}
        ...
        {:name => "advanced import success",
         ...
         :en => {:subject => "Advanced import was successful",
                 :body => "<p>Welcome {{user.email}}!</p><p>{{counter}} items had been imported to {{target_class}} \"{{target_name}}\".</p>"},
        ...
        {:name => "advanced import success with errors",
         ...
         :en => {:subject => "Advanced import has finished but some errors were found",
                 :body => "<p>Welcome {{user.email}}!</p><p>{{counter}} items had been imported to {{target_class}} \"{{target_name}}\".</p><p> Errors: {{errors}}</p>"},
        ...
        {:name => "advanced import fail",
         ...
         :en => {:subject => "Advanced import failed",
                 :body => "<p>Welcome {{user.email}}!</p><p>Sorry, there was problem with chosen fields while trying to import data to {{target_class}} \"{{target_name}}\".</p>"},
