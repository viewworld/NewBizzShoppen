...
(function () {
    var a = function (b, c) {
        ...
        var p = function (C, D) {
            ...
            if (!E) return null;
            var F = CKEDITOR.document.getById(w);
            if (E.getCustomData('isReady') == 'true') {
                if (D == 'check') {
                    var G = C.getValueOf('info', 'txtWidth'),
                        H = C.getValueOf('info', 'txtHeight'),
                        I = E.$.width * 1000 / E.$.height,
                        J = G * 1000 / H;
                    C.lockRatio = false;
                    if (!G && !H) C.lockRatio = true;
                    else if (!isNaN(I) && !isNaN(J)) if (Math.round(I) == Math.round(J)) C.lockRatio = true;
                } else if (D != undefined) C.lockRatio = D;
                else C.lockRatio = !C.lockRatio;
            } else if (D != 'check') C.lockRatio = false;
            if (C.lockRatio) F.removeClass('cke_btn_unlocked');
            else F.addClass('cke_btn_unlocked');
            var K = C._.editor.lang.image,
                L = K[C.lockRatio ? 'unlockRatio' : 'lockRatio'];
            F.setAttribute('title', L);
            F.getFirst().setText(L);
            return C.lockRatio;
        },
            q = function (C) {
            ...
            B = v('previewImage');
        return {
            title: c == 'image' ? b.lang.image.title : b.lang.image.titleButton,
            minWidth: 420,
            minHeight: 310,
            onShow: function () {
                var I = this;
                ...
                if (E && E.getName() == 'img' && !E.getAttribute('_cke_realelement') || E && E.getName() == 'input' && E.getAttribute('type') == 'image') {
                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            setup: function (C, D) {
                                if (C == d) {
                                    var E = D.getAttribute('_cke_saved_src') || D.getAttribute('src'),
                                        F = this;
                            ...
                            commit: function (C, D) {
                                ...
                                if (C == d && (E.getValue() || E.isChanged())) {
                                    D.setAttribute('_cke_saved_src', decodeURI(E.getValue()));
                                    D.setAttribute('src', decodeURI(E.getValue()));
                                } else if (C == g) {
                                    D.setAttribute('src', '');
                        ...
                        },
                        {
                            ...
                            hidden: true,
                            filebrowser: {target:'info:txtUrl',action:'Browse',url:CKEDITOR.addQueryStringToUrl(b.config.filebrowserImageBrowseUrl, b.config.swf_params)}
                        }]
                    }]
                },
                {
                    ...
                    children: [{
                            ...
                            children: [{
                                ...
                                children: [{
                                    ...
                                    validate: function () {
                                        ...
                                        if (!C) alert(b.lang.image.validateWidth);
                                        return !!C;
                                    },
                                    setup: r,
                                    commit: function (C, D, E) {
                                        ...
                                        if (C == d) {
                                            ...
                                            else if (!F && this.isChanged()) D.removeStyle('width');
                                ...
                                },
                                {
                                    ...
                                    validate: function () {
                                        var C = this.getValue().match(i);
                                        if (!C) alert(b.lang.image.validateHeight);
                                        return !!C;
                                    },
                                    setup: r,
                                    commit: function (C, D, E) {
                                        ...
                                        if (C == d) {
                                            ...
                                            else if (!F && this.isChanged()) D.removeStyle('height');
                                            if (!E && C == d) D.removeAttribute('height');
                                        } else if (C == f) {
                                            var G = F.match(h);
                                            if (!G) {
                                                var H = this.getDialog().originalElement;
                        ...
                        },
                        {
                            ...
                            },
                            {
                                ...
                                widths: ['35%', '65%'],
                                style: 'width:90px',
                                label: b.lang.image.align,
                                'default': '',
                                items: [
                                    [b.lang.common.notSet, ''],
                                    [b.lang.image.alignLeft, 'left'],
                                    [b.lang.image.alignRight, 'right']
                                ],
                                onChange: function () {
                                    l(this.getDialog());
                                    o.call(this, 'advanced:txtdlgGenStyle');
            ...
            },
            {
                ...
                elements: [{
                    ...
                    commit: function (C, D) {
                        var E = this;
                        if (C == e) if (E.getValue() || E.isChanged()) {
                            D.setAttribute('_cke_saved_href', decodeURI(E.getValue()));
                            D.setAttribute('href', 'javascript:void(0)/*' + CKEDITOR.tools.getNextNumber() + '*/');
                            if (E.getValue() || !b.config.image_removeLinkByEmptyURL) E.getDialog().addLink = true;
                        }
                    }
                },
                {
                    ...
                    filebrowser: {
                        action: 'Browse',
                        target: 'Link:txtUrl',
                        url: CKEDITOR.addQueryStringToUrl(b.config.filebrowserImageBrowseUrl, b.config.swf_params)
                    },
                    style: 'float:right',
                    hidden: true,
                    label: b.lang.common.browseServer
            ...
            },
            {
                ...
                },
                {
                    type: 'fileButton',
                    id: 'uploadButton',
                    filebrowser: {target:'info:txtUrl',action:'QuickUpload',url:CKEDITOR.addQueryStringToUrl(b.config.filebrowserImageUploadUrl, b.config.swf_params)},
                    label: b.lang.image.btnUpload,
                    'for': ['Upload', 'upload']
                }]
            },
