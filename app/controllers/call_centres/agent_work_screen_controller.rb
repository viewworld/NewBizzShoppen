class CallCentres::AgentWorkScreenController < CallCentres::CallCentreController
  ...
  def index
    set_locals
    redirect_to call_centres_campaign_agent_work_screen_index_path(Campaign.find(params[:change_campaign_id])) if params[:change_campaign_id]
  end
