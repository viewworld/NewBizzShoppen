class CallCentres::ResultsController < CallCentres::CallCentreController
  ...
  def create
    ...
    create! do |success, failure|
      success.html { redirect_to call_centres_campaign_results_path(@campaign) }
  ...
  def update
    ...
    if @result.save
      redirect_to call_centres_campaign_results_path(@campaign)
    else
     render 'edit' 
    end
  end
