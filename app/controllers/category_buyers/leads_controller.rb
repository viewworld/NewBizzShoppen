class CategoryBuyers::LeadsController < ApplicationController
  ...
  def collection
    ...
    @categories = user_signed_in? ? current_user.buying_categories_with_descendants.with_leads.without_locked_and_not_published : Category.with_leads.without_locked_and_not_published.without_unique
