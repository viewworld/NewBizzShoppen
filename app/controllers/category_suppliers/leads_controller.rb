class CategorySuppliers::LeadsController < ApplicationController
  ...
  def collection
    ...
    @categories = user_signed_in? ? current_user.parent_accessible_categories_without_auto_buy.with_leads.without_locked_and_not_published : LeadCategory.with_leads.without_locked_and_not_published.without_unique
