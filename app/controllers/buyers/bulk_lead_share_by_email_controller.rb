class Buyers::BulkLeadShareByEmailController < Buyers::BuyerController
  ...
  def create
    ...
    params[:email_template_preview].tap do |email_params|
      ApplicationMailer.generic_email(email_params[:recipients], email_params[:subject], email_params[:body], nil, [], @email_template_preview.cc, @email_template_preview.bcc).deliver
    end
