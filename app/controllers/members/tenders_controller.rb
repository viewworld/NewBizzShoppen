class Members::TendersController < Members::MemberController
  ...
  def new
    ...
    @lead.category_id = params[:category_id] if params[:category_id]
  ...
  def create
    ...
    @lead.price = @lead.category.default_price if @lead.category
    @lead.currency = @lead.category.currency if @lead.category
    @tender = @lead
