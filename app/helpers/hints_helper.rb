module HintsHelper
  def hint_for(object, method)
    ...
    admin_edit_link = (current_user and current_user.has_role?(:admin)) ? link_to(image_tag("icons/edit.png"), edit_administration_hint_path(@hint), :title => t("common.edit_hint")) : ""
