class Invoice < ActiveRecord::Base
  ...
  after_create :generate_invoice_lines_for_supplier, :generate_invoice_lines_for_subscriber, :generate_invoice_lines_for_refund, :generate_invoice_line_for_voucher
