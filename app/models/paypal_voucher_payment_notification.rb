class PaypalVoucherPaymentNotification < VoucherPaymentNotification
  def self.process(params)
    ...
    payment_notification = PaypalVoucherPaymentNotification.create!(:params => params, :buyer_id => user_id.to_i, :status => params[:payment_status], :transaction_id => params[:txn_id])
