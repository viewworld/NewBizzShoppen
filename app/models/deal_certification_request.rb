class DealCertificationRequest < ActiveRecord::Base
  ...
  def process
    ...
    self.save!
    TemplateMailer.delay(:queue => 'emails').new(contact_email, :deal_certification_request, Country.get_country_from_locale, {:deal_certification_request => self, :sender_id => nil})
  end
