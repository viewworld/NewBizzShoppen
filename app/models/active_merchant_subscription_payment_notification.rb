      ...
      if active_subscription
        ...
        if active_subscription.unconfirmed_payment?
          ...
          if user.errors.empty?
            ...
            user.with_role.notify!(:title => I18n.t("notifications.subscription.downgrade_failed.title"), :text => I18n.t("notifications.subscription.downgrade_failed.body", :error => user.errors.full_messages))
          end
        else
