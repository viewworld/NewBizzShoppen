class ActiveMerchantSubscriptionPaymentNotification < SubscriptionPaymentNotification
  ...
  def self.process(params)
    ...
    payment_notification = ActiveMerchantSubscriptionPaymentNotification.create!(:params => params, :buyer_id => subscription.user_id, :status => TRANSACTION_STATUSES[params[:qpstat]], :transaction_id => params[:transaction])
