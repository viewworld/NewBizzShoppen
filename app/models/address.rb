class Address < ActiveRecord::Base
  ...
  validates_presence_of :address_line_1, :address_line_3, :zip_code, :country_id
    #, :unless => Proc.new { |a| ActiveRecord::ConnectionAdapters::Column.value_to_boolean(a.disabled_validations) == true  }
