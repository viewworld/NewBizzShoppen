...
(function($){
	...
	*/
	$.gritter.remove = function(id, params, e, manual_close){
		Gritter.removeSpecific(id, params || {}, e, manual_close);
	}
	...
	var Gritter = {
		...
		*/
		add: function(params){
			...
			this._item_count++;
            this._id = params.id || this._item_count;
			var number = this._id,
				tmp = this._tpl_item;
			...
			tmp = this._str_replace(
				...
				[user, text, this._tpl_close, image_str, this._id, class_name, item_class], tmp
			);
            ...
            // Don't show another gritter message with the same ID
            if($('#gritter-item-' + number).length > 0) {
                return false;
            }

			$('#gritter-notice-wrapper').addClass(position).append(tmp);
			
			var item = $('#gritter-item-' + this._id);
