...
describe Debtor do
  ...
  context "subscriptions" do
    before(:each) do
      ...
      @payable_subscription1 = SubscriptionPlan.make!(:assigned_roles => [:supplier], :subscription_period => 12, :billing_cycle => 12, :use_online_payment => false, :billing_period => 0)
      @payable_subscription1.subscription_plan_lines.make!(:price => 15)
      @payable_subscription2 = SubscriptionPlan.make!(:assigned_roles => [:supplier], :subscription_period => 12, :billing_cycle => 3, :use_online_payment => false, :billing_period => 0)
      @payable_subscription2.subscription_plan_lines.make!(:price => 21.36)
      @payable_subscription3 = SubscriptionPlan.make!(:assigned_roles => [:supplier], :subscription_period => 12, :billing_cycle => 3, :use_online_payment => true, :billing_period => 0)
